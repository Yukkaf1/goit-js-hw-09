...
const flatpick = (0, _flatpickrDefault.default)("#datetime-picker", options);
...
const timer = {
    ...
    start () {
        ...
        this.timerId = setInterval(()=>{
            ...
            if (value <= 1000) this.stop(this.timerId);
        }, 1000);
    },
    stop () {
...
},{}],"eVN6V":[function() {},{}]},["8NMcg","1AWyZ"], "1AWyZ", "parcelRequire2afd")
